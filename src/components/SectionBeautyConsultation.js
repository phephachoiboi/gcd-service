...
import "../App.css";
import Animation1Beauty from "../assets/images/Animation1Beauty.png";
  ...
  return (
    <div className="w-full lg:px-0 md:px-6 sm:px-4">
      <div className="w-full">
        <div
          className="flex lg:flex-row flex-col max-w-[1137px] w-full h-auto mt-[141px] mx-auto lg:justify-between
    lg:items-start items-center"
        >
          {/* Left side Illustration 1 image  */}
          <div className="max-w-[475px] w-full h-auto mt-0">
            <img src={Animation1Beauty} alt="" />
          </div>
         ...
         lg:leading-[45px] leading-[38px] text-[#091156] "
            ...
            <button className="w-full h-auto cursor-pointer mt-[9px]">
